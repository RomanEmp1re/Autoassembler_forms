...
declare 
	...
	@structure varchar(20) = '', -- структурный элемент
	...
	@labelcount int = 0, -- для счета надписей и правильного их наименования
	@items nvarchar(4000) = '', -- список элементов выпадающего списка
	@fontstyle varchar(30), -- стиль шрифта
	@fontsize int, -- размер шрифта
	@is_last_in_row bit = 0; -- является ли элемент последним в строке
	...
	@parentgroup int = -1, -- родительская группа
	@group_col int = 0, -- столбец в группе
